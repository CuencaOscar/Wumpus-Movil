...
const Control_Botones = ({ name, direction, onPress, params }: Props) => {
    ...
    return (
        <View style={
            ...
            <TouchableOpacity style={{ backgroundColor: personajes[params].arrowColor, borderRadius: 50, width: 70, height: 70, justifyContent: 'center', alignItems: 'center' }} onPress={onPress}>
